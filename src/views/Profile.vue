<template>
  <div class="space-y-6">
    <div class="flex items-center gap-2 cursor-pointer mb-4">
      <button v-if="activeTab === 'education'"
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
      <!-- Tabs -->
      <div
        class="flex flex-wrap gap-2 p-1 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-[#0F1015]">
    ...
    <div v-if="activeTab === 'personal'" class="grid grid-cols-1 md:grid-cols-2 gap-5">
      ...
      <div
        ...
        <div class="space-y-4">
          ...
          <BaseInput :label="t('phone')" type="text" placeholder="+998 (99) 999-99-99" v-model="phone"
            maskType="phone" />
